...
project = u'feedinlib'
copyright = u'2015, oemof developer group'
...
version = '%s' % (feedinlib.__version__)
...
texinfo_documents = [
  ('index', 'feedinlib', u'feedinlib Documentation',
   'feedinlib', 'Calculate time series of wind and pv power plants from weather data.',
   'Miscellaneous'),
]
...
epub_copyright = u'2015, oemof developer group'
