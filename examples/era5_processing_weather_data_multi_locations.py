...
# The example netCDF-file is fetched from the era5-server with the following
# bounding box: latitude = [52.3, 52.7]  longitude = [13.1, 13.7]
...
region_shape = gpd.read_file("example_data/berlin_shape.geojson")
...
# dataframe will be a multiindex with levels (time, latitude, longitude). Be
# aware that in order to use it for pvlib or windpowerlib calculations you
# need to select just one location.
...
with open("example_data/germany_simple.geojson") as f:
